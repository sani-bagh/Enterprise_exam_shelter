...
class CustomAuthenticationFilter(
    ...
    override fun attemptAuthentication(request: HttpServletRequest, response: HttpServletResponse): Authentication {
        ...
        val loginInfo: LoginInfo = jacksonObjectMapper().readValue(body, LoginInfo::class.java)
        println("loginInfo is $loginInfo")
        val authenticationToken = UsernamePasswordAuthenticationToken(loginInfo.email, loginInfo.password)
